...
<div class="header">
            ...
            <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                ...
                <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                    <div class="u-info me-2">
                        <p class="mb-0 text-end line-height-sm "><span class="font-weight-bold"><?php echo ($userData->username);?></span></p>
 ...
 <!-- A Product of KodeMadeEazy| FlatERP Teach |For Project Call 08131374443 -->
                                <div><hr class="dropdown-divider border-dark"></div>
                            </div>
                            <div class="list-group m-2">
                                
                                <a href="../app/View?user-action=logoutadmin" onclick="return confirm('Are you sure, You want to Sign out?');" class="list-group-item list-group-item-action border-0 "><i class="icofont-logout fs-5 me-3"></i>Signout</a>
            ...
            <div class="order-0 col-lg-6 col-md-8 col-sm-12 col-12 mb-3 mb-md-0 ">
                ...
                <p class="text-danger fw-bold" style="font-size:16px;"> <marquee>A Product of FlatERP Teach |For Project Call +234813-1374-443 OR info@flaterptech.com</marquee> </p>
